    ...
    <div className='descriptionbox'>
        ...
        <div className="descriptionbox-description">
            <p>An e-commerce website is an online platform that facilitates the buying and selling of products or services over the internet. 
                ...
                transactions without the need for a physical presence. E-commerce websites have gained immerse popularity due to their 
                ...
                <p> E-commerce websites typically display products or services along with detailed descriptions, images, prices 
                    and any available variations (e.g. sizes, colors). Each product usually has its own delicated page with relevant interaction.
            </p>
        </div>
    </div>
  )
